...
class Parser:
    ...
    def _add_arguments(self) -> None:
        ...
        self._parser.add_argument(
                ...
                help="other arguments used when opening VLC. Note that some like args='--fullscreen' won't work in here")
        ...
        self._parser.add_argument(
                ...
                help="your Spotify username. Mandatory if the web API is being used. Example: --username='yourname'")

        self._parser.add_argument(
                "--client-id",
                action="store", dest="client_id", default=None,
                help="your client ID. Mandatory if the web API is being used. Check the README to see how to obtain yours. Example: --client-id='5fe01282e44241328a84e7c5cc169165'")

        self._parser.add_argument(
                "--client-secret", 
                action="store", dest="client_secret", default=None,
                help="your client secret ID. Mandatory if the web API is being used. Check the README to see how to obtain yours. Example: --client-secret='2665f6d143be47c1bc9ff284e9dfb350'")
