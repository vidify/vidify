...
These functions also check if Vidify is set in server mode. In that case,
rather than playing the videos in the GUI, the data is sent to the connected
clients. The defined object model for the API is:
