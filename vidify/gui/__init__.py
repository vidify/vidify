...
class ResBase:
    ...
    github = res_path('github.svg')
    menu = res_path('menu.svg')
    ...
    def set_dark_mode(self) -> None:
        ...
        self.github = res_path('dark_mode_github.svg')
        self.menu = res_path('dark_mode_menu.svg')
...
class FontsBase:
    ...
    link = QFont("Inter", 16, QFont.Bold)
    link.setItalic(True)
