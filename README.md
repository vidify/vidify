...
* Other installation methods for Linux:
    ...
    * Arch Linux: Vidify is available on the AUR: [`vidify`](https://aur.archlinux.org/packages/vidify/). Maintained by me ([marioortizmanero](https://github.com/marioortizmanero)).
