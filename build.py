...
if cur_os == 'Windows':
    ...
    ret = subprocess.run(["find", "/", "-name", "libmpv.so", "-print", "-quit"], stdout=subprocess.PIPE, stderr=subprocess.DEVNULL)
...
args_os = {
    ...
    os.path.join("src", "vidify", "api", "spotify", "swspotify.py"): ['Windows', 'Darwin'],
}
